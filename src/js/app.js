...
function iniciarApp() {
    mostrarSeccion();
    tabs(); //Cambia la seccion cuando se presionan los tab
    botonesPaginador();//Agrega o quita losbotones del paginador
    paginaSiguiente();
    paginaAnterior();
    ...
    mostrarResumen();//Muestra el resumen de la lista
}
...
function mostrarSeccion() {
    ...
    //Selecccionar la seleccion con Paso
...
function seleccionarServicio(servicio) {
    ...
    //Identifica el elemento al q se le da click
...
function mostrarResumen() {
    ...
    //Heading para Citass en resumen
...
async function reservarCita() {
    ...
    if(resultado.resultado){
        ...
        Swal.fire({
            icon: "error",
            title: "Error",
            text: "Hubo error al crear la cita",
